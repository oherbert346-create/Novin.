...
DB_URL=postgresql+asyncpg://neondb_owner:npg_XkB4SfouO5wl@ep-wild-glade-abkt645s-pooler.eu-west-2.aws.neon.tech/neondb

# Auth - Basic HTTP Auth (use generated credentials above)
BASIC_AUTH_USER=pilot_user_AIOmVjQBUko
BASIC_AUTH_PASS=Et-01LocQpkCq3K7uC0q7laFp2ylGEEHhabUO-BxYDI
...
```bash
curl -u pilot_user_AIOmVjQBUko:Et-01LocQpkCq3K7uC0q7laFp2ylGEEHhabUO-BxYDI \
